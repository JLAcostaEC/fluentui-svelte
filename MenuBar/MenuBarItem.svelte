<script>import { currentMenu } from "./flyoutState";
import { tabbable } from "tabbable";
import { createEventDispatcher, getContext, setContext } from "svelte";
import { get_current_component } from "svelte/internal";
import { createEventForwarder, arrowNavigation, externalMouseEvents, uid } from "../internal";
...
<style>.menu-bar-item{align-items:center;background-color:var(--fds-subtle-fill-transparent);border-radius:var(--fds-control-corner-radius);color:var(--fds-text-primary);cursor:default;display:inline-flex;font-family:var(--fds-font-family-text);font-size:var(--fds-body-font-size);font-weight:400;line-height:20px;margin:4px;padding:5px 11px;position:relative;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.menu-bar-item:hover{background-color:var(--fds-subtle-fill-secondary)}.menu-bar-item:active,.menu-bar-item[aria-expanded=true]{background-color:var(--fds-subtle-fill-tertiary)}.menu-bar-item:active:hover,.menu-bar-item[aria-expanded=true]:hover{background-color:var(--fds-subtle-fill-secondary)}.menu-bar-item:active{color:var(--fds-text-secondary)}.menu-bar-item.disabled{background-color:var(--fds-subtle-fill-disabled)!important;color:var(--fds-text-disabled)}.menu-flyout-anchor{inset-block-start:100%;inset-inline-start:0;position:absolute;z-index:10000}</style>
