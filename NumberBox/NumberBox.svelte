<script>import TextBox from "../TextBox/TextBox.svelte";
...
export let spinUpButtonElement = null;
...
<style>:global(.number-box) :global(input){-webkit-appearance:textfield;-moz-appearance:textfield;appearance:textfield}:global(.number-box) :global(input::-webkit-inner-spin-button),:global(.number-box) :global(input::-webkit-outer-spin-button){-webkit-appearance:none;appearance:none;margin:0}.number-box-spinner-flyout{background-clip:padding-box;background-color:var(--fds-solid-background-quarternary);border:1px solid var(--fds-surface-stroke-flyout);border-radius:var(--fds-overlay-corner-radius);box-shadow:var(--fds-flyout-shadow);box-sizing:border-box;display:flex;flex-direction:column;inset-inline-end:-16px;padding:2px 4px;position:absolute;z-index:100}.number-box-spinner-flyout :global(.number-box-spinner){block-size:36px;inline-size:36px;margin:2px 1px}</style>
